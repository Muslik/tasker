...
A Verify block resolves registered project command/runtime operations; a Delivery block
resolves typed Git/tracker/SCM/CI adapters. Every internal operation has its own durable

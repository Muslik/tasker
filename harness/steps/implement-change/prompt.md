...
attempt, implement the bounded plan. On a later attempt, use the persisted Verify or Review findings
as the repair input and preserve already correct work.

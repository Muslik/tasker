...
- repeated agent attempts inline only the latest/accepted/interrupted causal frontier per semantic
  node while preserving a complete mounted receipt history for explicit inspection.

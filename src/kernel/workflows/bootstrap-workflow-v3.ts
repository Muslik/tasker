...
import type { JsonValue } from '../../graph/index.js';
  ...
  for (;;) {
    ...
    try {
      freezeReceipt = await activities.freezeTaskWorkflow({
        ...
        semanticHash: acceptedDraft.semanticHash,
        compilerVersion: acceptedDraft.compilerVersion,
        harnessSnapshotHash: acceptedDraft.harnessSnapshotHash,

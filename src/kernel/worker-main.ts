...
import { ContextDiscoveryService, EvidenceBundleStore } from '../server/evidence-bundle.js';
import { PlanningTranscriptStore } from '../server/planning-transcript.js';
import { createOperatorWorkflowService } from '../server/operator-service.js';
import {
  PersistedGenerationSubjectResolver,
  PersistedGenerationSubjectRunStore,
} from '../server/persisted-generation-subject.js';
...
import { RetrospectiveStore } from '../server/report.js';
import {
...
import { createWorkspaceActivity } from '../steps/activities/workspace-activity.js';
import { createBootstrapContextAssemblyActivity } from '../steps/activities/bootstrap-context-assembly-activity.js';
import { createBootstrapInvestigationActivity } from '../steps/activities/bootstrap-investigation-activity.js';
import { createWorkflowFreezeActivity } from '../steps/activities/workflow-freeze-activity.js';
import { createTaskAdmissionActivity } from '../steps/activities/task-admission-activity.js';
import { WorkspaceMutationRecoveryStore } from '../steps/activities/workspace-mutation-recovery.js';
import { createExecutionContinuationActivity } from '../steps/activities/execution-continuation-activity.js';
import { createExecutionRetrospectiveActivity } from '../steps/activities/execution-retrospective-activity.js';
